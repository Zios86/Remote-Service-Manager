...
Актуально для версии **2.2.1**. Этот документ — первая точка входа для разработчика или ИИ перед изменением проекта.
...
- `Test-LinuxTcpEndpoint` — отдельная проверка TCP-порта до запуска SSH.
